...
<br>
 <form action="addVenueForm.do" method="POST">
        ...
        Street: <input required type="text" name="address" /> <br>      
        City: <input required type="text"  name="city" /> <br>      
        State: <input required type="text" name="state" /> <br>      
        Zip Code: <input required type="number" name="zip" /> <br>      
        Description: <input required type="text" name="description" /> <br> 
 		Capacity: <input required type="number" name="capacity" /> <br>
        ...
        <br>
        <br>
        	<input type="submit" class="btn btn-success btn-lg" value="Add Venue">
